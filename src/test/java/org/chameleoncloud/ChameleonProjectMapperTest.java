...
public class ChameleonProjectMapperTest {
  ...
  public void shouldAddProjectClaims() {
    ...
    assertThat(accessToken.getOtherClaims().get(CLAIM_NAME))
        .isEqualToComparingFieldByFieldRecursively(List.of(new ChameleonProject("project-1", Optional.empty()),
            new ChameleonProject("project-2", Optional.of("nickname-2"))));
  ...
  private class HardcodedGroupModel implements GroupModel {
