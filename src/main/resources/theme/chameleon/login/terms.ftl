...
<@layout.registrationLayout displayMessage=false; section>
    ...
    <#elseif section = "form">
        <div id="kc-terms-text">
            ...
            <ul>
                <li>
                    <a href="https://portal.tacc.utexas.edu/tacc-usage-policy">TACC usage policy</a>
                </li>
                <li>
                    <a href="https://wiki.ci.uchicago.edu/Resources/UserPolicy">Univ of Chicago User Policy</a>
                </li>
                <li>
                    <a href="https://wiki.ci.uchicago.edu/Resources/PasswordGuidelines">Univ of Chicago Password Policy</a>
                </li>
            </ul>
            ...
            <p>
                ...
                <a href="https://www.chameleoncloud.org/user/help/">Help System</a>.
            </p>
